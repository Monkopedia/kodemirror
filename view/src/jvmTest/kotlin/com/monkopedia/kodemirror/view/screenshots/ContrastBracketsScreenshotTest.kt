...
class ContrastBracketsScreenshotTest {
    ...
    fun capture() = runDesktopComposeUiTest(width = 800, height = 600) {
        setContent {
            val state = remember {
                ...
                // Cursor right after the opening { on line 1
                val cursorPos = doc.indexOf("{") + 1
                EditorState.create(
                    EditorStateConfig(
                        doc = doc.asDoc(),
        ...
        onRoot().captureScreenshot("screenshots/compose/contrast-brackets.png")
    }
}
