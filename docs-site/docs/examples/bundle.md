...
kotlin {
    sourceSets {
        commonMain.dependencies {
            ...
            implementation("com.monkopedia.kodemirror:search:0.3.6")

            // Language support (pick what you need)
            implementation("com.monkopedia.kodemirror:lang-javascript:0.3.6")
            implementation("com.monkopedia.kodemirror:lang-python:0.3.6")

            // Optional features
            implementation("com.monkopedia.kodemirror:autocomplete:0.3.6")
            implementation("com.monkopedia.kodemirror:lint:0.3.6")
