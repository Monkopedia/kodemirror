...
kotlin {
    sourceSets {
        commonMain.dependencies {
            ...
            implementation("com.monkopedia.kodemirror:search:0.3.7")

            // Language support (pick what you need)
            implementation("com.monkopedia.kodemirror:lang-javascript:0.3.7")
            implementation("com.monkopedia.kodemirror:lang-python:0.3.7")

            // Optional features
            implementation("com.monkopedia.kodemirror:autocomplete:0.3.7")
            implementation("com.monkopedia.kodemirror:lint:0.3.7")
