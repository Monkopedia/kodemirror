...
object ChangeTest {
    ...
    object ChangeDescTest {
        class composition {
            ...
            @Test
            fun cancels_insertions_with_deletions() =
                comp("4", "2 0:2 2", "2 2:0 2")

            @Test
            fun joins_adjacent_insertions() =
                comp("2 0:5 2", "2 0:2 2", "4 0:3 2")

            @Test
            fun joins_adjacent_deletions() =
                comp("1 6:0", "2 5:0", "1 1:0")

            @Test
            fun allows_a_delete_to_shadow_multiple_operations() =
                comp("4:0", "2 2:0 0:3", "5:0")

            @Test
            fun can_handle_empty_sets() =
                comp("", "", "0:8", "8:0", "")
        ...
        class mapping {
            ...
            @Test
            fun can_map_over_an_insertion() =
                over("4 0:1", "0:3 4", "7 0:1")

            @Test
            fun can_map_over_a_deletion() =
