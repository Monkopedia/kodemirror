...
val lessHighlighting = styleTags(
    mapOf(
        "import charset namespace keyframes media supports when" to t.definitionKeyword,
        ...
        "FeatureName PropertyName PropertyVariable" to t.propertyName,
        ...
        "AtKeyword Interpolation" to t.special(t.variableName),
